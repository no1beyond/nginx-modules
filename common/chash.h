...
#ifndef _NGX_HTTP_UPSTREAM_CHASH_H_INCLUDED_
#define _NGX_HTTP_UPSTREAM_CHASH_H_INCLUDED_
...
static char * ngx_http_upstream_init_hash_key(ngx_conf_t *cf, ngx_str_t *s);
...
static char *
ngx_http_upstream_init_hash_key(ngx_conf_t *cf, ngx_str_t *s)
{
...
#endif /* _NGX_HTTP_UPSTREAM_CHASH_H_INCLUDED_ */
